...
Working(p) == /\ ProcStates[p] = "working"
              ...
              /\ UNCHANGED <<ProcStates, SigStates, SigStorage, ProcSignals>>
...
Flag(p,s) == /\ ProcStates[p] = "working"
             ...
             /\ UNCHANGED <<ProcValues, SigStorage, ProcSignals>>
...
Send(p,s) == /\ ProcStates[p] = "working"   
             ...
             /\ UNCHANGED <<ProcStates, ProcValues, ProcSignals>>
...
Receive(p,s) == /\ ProcStates[p] = "ready"
                ...
                /\ UNCHANGED <<SigStorage, ProcSignals>>
...
\* Last modified Mon Feb 10 16:59:44 MSK 2020 by zakharov
