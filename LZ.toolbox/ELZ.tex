...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ELZ}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
This model describes the semantics of rendezvous signal exchange
 intended for \ensuremath{C} programs verification tools. These operations
 should not
...
\@xx{}%
\@pvspace{16.0pt}%
\@x{ {\VARIABLES} SigStates ,\,\@s{16.92}}%
\@y{\@s{0}%
 Describes the state of each signal transition.
 *\ensuremath{\.{\,\backslash\,}
}}%
\@xx{}%
\@x{\@s{51.42} ProcStates ,\,\@s{10.52}}%
\@y{\@s{0}%
 Process states: working or ready. *\ensuremath{\.{\,\backslash\,}
}}%
\@xx{}%
\@x{\@s{51.42} ProcValues ,\,\@s{8.2}}%
\@y{\@s{0}%
 Current values stored per process *\ensuremath{\.{\,\backslash\,}
}}%
\@xx{}%
\@x{\@s{51.42} SigStorage ,\,\@s{10.98}}%
\@y{\@s{0}%
 Describes the state of each process. *\ensuremath{\.{\,\backslash\,}
}}%
\@xx{}%
\@x{\@s{51.42} ProcSignals\@s{4.1}}%
\@y{\@s{0}%
 Specifies the signal that expected to be received
 *\ensuremath{\.{\,\backslash\,}
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} SigStates ,\, ProcStates ,\, ProcValues ,\,
...
\end{cpar}%
\end{lcom}%
 \@x{ Init \.{\defeq} \.{\land} SigStates \.{=} [ s \.{\in} Signals
 \.{\mapsto}\@w{idle} ]}%
 \@x{\@s{35.70} \.{\land} SigStorage\@s{2.78} \.{=} [ s\@s{0.83} \.{\in}
 Signals \.{\mapsto} 0 ]}%
 \@x{\@s{35.70} \.{\land} ProcStates\@s{2.32} \.{=} [ p \.{\in} Processes
 \.{\mapsto}\@w{working} ]}%
 \@x{\@s{35.70} \.{\land} ProcValues \.{=} [ p \.{\in} Processes \.{\mapsto} 0
 ]}%
 \@x{\@s{35.70} \.{\land} ProcSignals \.{=} [ p \.{\in} Processes \.{\mapsto}
 0 ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ Working ( p ) \.{\defeq} \.{\land} ProcStates [ p ] \.{=}\@w{working}}%
 \@x{\@s{70.49} \.{\land} \E\, i \.{\in} WorkingSet \.{:}\@s{4.1} ProcValues
 \.{'} \.{=} [ ProcValues {\EXCEPT} {\bang} [ p ] \.{=} i ]}%
 \@x{\@s{70.49} \.{\land} {\UNCHANGED} {\langle} ProcStates ,\, SigStates ,\,
 SigStorage ,\, ProcSignals {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ Flag ( p ,\, s ) \.{\defeq} \.{\land} ProcStates [ p ]
 \.{=}\@w{working}}%
 \@x{\@s{63.10} \.{\land} ProcStates \.{'} \.{=} [ ProcStates {\EXCEPT}
 {\bang} [ p ] \.{=}\@w{ready} ]}%
\@x{\@s{63.10} \.{\land} SigStates [ s ] \.{=}\@w{idle}}%
 \@x{\@s{63.10} \.{\land} SigStates \.{'} \.{=} [ SigStates {\EXCEPT} {\bang}
 [ s ] \.{=}\@w{waiting} ]}%
 \@x{\@s{63.10} \.{\land} {\UNCHANGED} {\langle} ProcValues ,\, SigStorage ,\,
 ProcSignals {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Send value to any process that waits signal ``\ensuremath{s}''.
\end{cpar}%
\end{lcom}%
 \@x{ Send ( p ,\, s ) \.{\defeq} \.{\land} ProcStates [ p ]
 \.{=}\@w{working}}%
\@x{\@s{65.41} \.{\land} SigStates [ s ] \.{=}\@w{waiting}}%
 \@x{\@s{65.41} \.{\land} SigStates \.{'} \.{=} [ SigStates {\EXCEPT} {\bang}
 [ s ] \.{=}\@w{set} ]}%
 \@x{\@s{65.41} \.{\land} SigStorage \.{'} \.{=} [ SigStorage {\EXCEPT}
 {\bang} [ s ] \.{=} ProcValues [ p ] ]}%
 \@x{\@s{65.41} \.{\land} {\UNCHANGED} {\langle} ProcStates ,\, ProcValues ,\,
 ProcSignals {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ Receive ( p ,\, s ) \.{\defeq} \.{\land} ProcStates [ p ]
 \.{=}\@w{ready}}%
\@x{\@s{76.00} \.{\land} SigStates [ s ] \.{=}\@w{set}}%
\@x{\@s{76.00} \.{\land} ProcSignals [ p ] \.{=} s}%
 \@x{\@s{76.00} \.{\land} ProcStates \.{'}\@s{2.32} \.{=} [ ProcStates
 {\EXCEPT} {\bang} [ p ]\@s{2.32} \.{=}\@w{working} ]}%
 \@x{\@s{76.00} \.{\land} ProcValues \.{'} \.{=} [ ProcValues {\EXCEPT}
 {\bang} [ p ] \.{=} SigStorage [ s ] ]}%
 \@x{\@s{76.00} \.{\land} SigStates \.{'} \.{=} [ SigStates {\EXCEPT} {\bang}
 [ s ] \.{=}\@w{idle} ]}%
 \@x{\@s{76.00} \.{\land} {\UNCHANGED} {\langle} SigStorage ,\, ProcSignals
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
This action is an artificial one and intended for choosing another
 ...
 process\mbox{'}es signal when it is in the \ensuremath{\@w{ready}} state.
\end{cpar}%
\end{lcom}%
 \@x{ ChangeSignal ( p ) \.{\defeq} \.{\land} ProcStates [ p ]
 \.{=}\@w{working}}%
 \@x{\@s{92.21} \.{\land} \E\, s \.{\in} Signals \.{:} ProcSignals \.{'} \.{=}
 [ ProcSignals {\EXCEPT} {\bang} [ p ] \.{=} s ]}%
 \@x{\@s{92.21} \.{\land} {\UNCHANGED} {\langle} SigStates ,\, ProcStates ,\,
 ProcValues ,\, SigStorage {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
This action is an artificial one and intended for choosing another
...
\end{cpar}%
\end{lcom}%
\@x{ Next \.{\defeq} \E\, p \.{\in} Processes \.{:} \.{\lor} Working ( p )}%
\@x{\@s{115.92} \.{\lor} ChangeSignal ( p )}%
 \@x{\@s{115.92} \.{\lor} \E\, s \.{\in} Signals \.{:} \.{\lor} Flag ( p ,\, s
 )}%
\@x{\@s{192.32} \.{\lor} Send ( p ,\, s )}%
\@x{\@s{192.32} \.{\lor} Receive ( p ,\, s )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ TypeOK \.{\defeq} \.{\land} SigStates \.{\in} [ Signals \.{\rightarrow}
 \{\@w{idle} ,\,\@w{waiting} ,\,\@w{set} \} ]}%
 \@x{\@s{56.14} \.{\land} SigStorage\@s{2.78} \.{\in} [ Signals
 \.{\rightarrow} WorkingSet \.{\cup} \{ 0 \} ]}%
 \@x{\@s{56.14} \.{\land} ProcStates\@s{2.32} \.{\in} [ Processes
 \.{\rightarrow} \{\@w{working} ,\,\@w{ready} \} ]}%
 \@x{\@s{56.14} \.{\land} ProcValues \.{\in} [ Processes \.{\rightarrow}
 WorkingSet \.{\cup} \{ 0 \} ]}%
 \@x{\@s{56.14} \.{\land} ProcSignals \.{\in} [ Processes \.{\rightarrow}
 Signals \.{\cup} \{ 0 \} ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ PropPending \.{\defeq}\@s{4.1} \E\, x \.{\in} Processes \.{:} ProcStates
 [ x ] \.{=}\@w{ready} \.{\equiv} \E\, s \.{\in} Signals \.{:} SigStates [ s
 ] \.{\neq}\@w{idle}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 10 17:00:44 \ensuremath{MSK} 2020 by \ensuremath{zakharov
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Feb} 07
 12:23:21 \ensuremath{MSK} 2020 by \ensuremath{zakharov
}%
\end{cpar}%
\end{lcom}%
\end{document}
